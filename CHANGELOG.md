...
- Trajectory replaces a stale detached server when its server or UI files change, so `/workflow trajectory` and auto-open use the current implementation ([#226](https://github.com/vekexasia/pi-extensible-workflows/issues/226)).
