...
- [`@piewf/subagents`](./subagents/README.md) adds durable background subagent tools and the optional `singleAgent` workflow function; a name collision disables only that optional catalog entry.
