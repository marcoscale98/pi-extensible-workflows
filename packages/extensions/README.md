...
| --- | --- | --- | --- |
| [`@marcoscale98/piewf-herdr`](./herdr/README.md) | `pi install npm:@marcoscale98/piewf-herdr@fork` | Live and completed workflow-agent sessions in Herdr panes. Requires the scoped core package and a Herdr-managed pane. | [Herdr guide](https://vekexasia.github.io/pi-extensible-workflows/herdr.html) |
